...
class ExampleProvider(provider.Provider):
    ...
    def __init__(self):
        ...
        track_one = Item(id=1, artist="Tenacious D", album="The Pick of Destiny", name="The Metal", track=15, duration=166000, year=2006, genre="Rock", file_suffix="mp3", file_type="audio/mp3")
        track_two = Item(id=2, artist="Fait No More", album="The Real Thing", name="Epic", track=2, duration=291000,  year=1989, genre="Rock", file_suffix="mp3", file_type="audio/mp3")
        database.items.add(track_one)
        database.items.add(track_two)

        container_item_one_a = ContainerItem(id=1, item=track_one)
        container_item_one_b = ContainerItem(id=2, item=track_two)
        container_item_two_a = ContainerItem(id=3, item=track_one, order=1)
        container_item_two_b = ContainerItem(id=4, item=track_two, order=2)
        container_item_two_c = ContainerItem(id=5, item=track_one, order=3)
